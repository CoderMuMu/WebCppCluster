...
// optional string username = 1;
inline bool LoginParam::_internal_has_username() const {
...
// optional string password = 2;
inline bool LoginParam::_internal_has_password() const {
...
// optional uint64 user_id = 1;
inline bool LoginResult::_internal_has_user_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
...
// optional string token = 2;
inline bool LoginResult::_internal_has_token() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
